...
public class ClientSetup {
    ...
    public static void onRegisterRenderer(EntityRenderersEvent.RegisterRenderers event) {
        ...
        event.registerEntityRenderer(RATHALOS_TAIL.get(), (EntityRendererProvider.Context context) -> new TailRenderer(context, MHNWReferences.RATHALOS));
        event.registerEntityRenderer(RATHIAN_TAIL.get(), (EntityRendererProvider.Context context) -> new TailRenderer(context, MHNWReferences.RATHIAN));
