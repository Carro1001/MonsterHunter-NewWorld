...
import com.carro1001.mhnw.entities.ai.DragonTargetGoal;
...
public abstract class DragonEntity extends PathfinderMob implements IAnimatable, IAnimationTickable, IGrows {
    ...
    // 0 is IDLE, 1 is Fireball, 2 is moving, 3 roar
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(4, new DragonWalkGoal(this, 1.0D,0.001));
        this.goalSelector.addGoal(2, new LookAtPlayerGoal(this, Cow.class, 16.0F));
        this.targetSelector.addGoal(1, new DragonTargetGoal<>(this, Cow.class, false, false));
...
//    }
    ...
    public boolean shouldRoar() {
        return getStateDir() == 3 && !hasRoared();
    }
