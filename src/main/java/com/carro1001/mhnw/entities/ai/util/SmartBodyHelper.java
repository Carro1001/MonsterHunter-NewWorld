package com.carro1001.mhnw.entities.ai.util;
...
//            if (entity instanceof Mob) { // TODO: WHat's this mod's implementation?
//                canLook = ((HyperionLivingEntity) entity).getCanLook();
//            }
            if (canLook) {
