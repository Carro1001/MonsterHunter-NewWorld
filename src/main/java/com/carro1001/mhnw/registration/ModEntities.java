...
public class ModEntities {
    ...
    public static final RegistryObject<EntityType<AptonothEntity>> APTONOTH = registerEntity(MHNWReferences.APTONOTH,AptonothEntity::new, MobCategory.CREATURE,1.32F, 2.7F,8,false);
    ...
    public static final RegistryObject<EntityType<RathianEntity>> RATHIAN = registerEntity(MHNWReferences.RATHIAN,RathianEntity::new, MobCategory.CREATURE,5.7f, 3.4f,16,false);
    ...
    public static final RegistryObject<EntityType<RathalosEntity>> RATHALOS = registerEntity(MHNWReferences.RATHALOS,RathalosEntity::new, MobCategory.CREATURE,5.9f, 3.6f,16,false);
    ...
    public static final RegistryObject<EntityType<BlangongaEntity>> BLANGONGA = registerEntity(MHNWReferences.BLANGONGA,BlangongaEntity::new, MobCategory.CREATURE,1.4f, 2.2f,8,false);
    ...
    public static final RegistryObject<EntityType<IzuchiEntity>> IZUCHI = registerEntity(MHNWReferences.IZUCHI,IzuchiEntity::new, MobCategory.CREATURE,1.4f, 2.2f,8,false);
    public static final RegistryObject<Item> IZUCHI_EGG_ITEM = registerEntityEgg(MHNWReferences.IZUCHI, IZUCHI, 0xCC6D5A, 0xD4D7D9);

    public static final RegistryObject<EntityType<GreatIzuchiEntity>> GIZUCHI = registerEntity(GREAT+"_"+MHNWReferences.IZUCHI,GreatIzuchiEntity::new, MobCategory.CREATURE,1.4f, 2.8f,8,false);
    ...
    public static final RegistryObject<EntityType<ToadEntity>> TOAD = registerEntity(MHNWReferences.TOAD,ToadEntity::new, MobCategory.CREATURE,0.4f, 0.2f,8,false);
    ...
    public static final RegistryObject<EntityType<ZinogreEntity>> ZINOGRE = registerEntity(MHNWReferences.ZINOGRE,ZinogreEntity::new, MobCategory.CREATURE,4.4f, 4.2f,8,false);
    ...
    public static final RegistryObject<EntityType<LagiacrusEntity>> LAGIACRUS = registerEntity(MHNWReferences.LAGIACRUZ,LagiacrusEntity::new, MobCategory.CREATURE,1.4f, 3.2f,8,false);
    ...
    public static final RegistryObject<EntityType<DeviljhoEntity>> DEVILJHO = registerEntity(MHNWReferences.DEVILJHO,DeviljhoEntity::new, MobCategory.CREATURE,1.4f, 3.2f,8,false);
    ...
    public static final RegistryObject<EntityType<FlashBugEntity>> FLASHBUG = registerEntity(MHNWReferences.FLASHBUG,FlashBugEntity::new, MobCategory.AMBIENT,0.4f, 0.2f,8,false);
